        ...
        if (currentStep < 3) {
            ...
            try {
                const orderData = {
                    ...
                    designType: designPrompt || 'Custom Design',
                    measurements: {
                    ...
                    totalAmount: 299.99
                    // Note: status and orderId are auto-generated by backend
                };
                ...
                if (response.ok) {
                    ...
                    alert(`Failed to submit order: ${response.status}. Please check console for details.`);
                }
            } catch (error) {
